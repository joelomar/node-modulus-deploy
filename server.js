...
var auth = function (req, res, next) {
    ...
    if (req.session && req.session.user === codeAuth && req.session.admin) {
            ...
            res.redirect('http://app-90967.onmodulus.net/401');
    }
};
...
app.post('/register', function (req, res) {
    ...
    res.redirect('http://app-90967.onmodulus.net/login');
...
app.post('/login', function (req, res) {
    ...
    //res.end(JSON.stringify(req.body));
        ...
        res.redirect('http://app-90967.onmodulus.net');
...
app.get('/401', function (req, res) {
        ...
        res.sendFile('./client/401.html', {root: __dirname});
...
server.listen(port, function() {
    ...
    console.log('Mod server waiting for connections in env port');
});
